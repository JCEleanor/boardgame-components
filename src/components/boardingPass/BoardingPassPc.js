      ...
      <div className="booking-info-wrapper">
        <div className="main-text-wrapper">
          ...
          <div className="booking-main-info-row">
            ...
            <div className="booking-info-content">{bookingName}</div>
          </div>
          <div className="booking-main-info-row">
            <div className="booking-info-title">訂單成立日</div>
            <div className="booking-info-content">{orderPlaceDate}</div>
          </div>
          <div className="booking-main-info-row">
            <div className="booking-info-title">聯絡資訊</div>
            <div className="booking-info-content">{bookingContact}</div>
          </div>
          <div className="booking-main-info-row">
            <div className="booking-info-title">人數</div>
            <div className="booking-info-content">{people} 人</div>
          </div>
        </div>
